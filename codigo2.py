...
#Devuelve el valor del parámetro en binario. 
def binario (numero):
    return bin(numero)[2:].zfill(4) #Usamos el [2:] para que imprima apartir de la segunda posición (porque "bin" lo imprime como "0b'xxxx '")
